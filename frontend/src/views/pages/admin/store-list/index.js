...
function StoreList() {
    ...
    const menu = () => {
        return (
            <Menu className="store-list-menu">
                <div className="store-list-menu__item">
                    <div className="store-list-menu__item__row">
                        <span className="store-list-menu__item__row__span">
                            Trạng thái
                        </span>
                        <select
                            className="store-list-menu__item__row__select"
                            onChange={(e) => {
                                e.target.value === 'All'
    ...
    return (
        <div>
            ...
            <div className="store-list-content__action">
                <div className="store-list-content__action__select">
                    <span className='store-list-content__action__span'>Hiển thị </span>
                    <select
                    ...
                    <div
                        className={
                            params.is_deleted !== null
                                ? 'store-list-content__action__filter-active'
                                : 'store-list-content__action__filter-unactive'
                        }
                    >
                        <FilterOutlined />
                    </div>
                ...
                <div className="store-list-content__action__search">
                    <Search
                        ...
                        suffix
                    />
                    <SearchOutlined className="store-list-content__action__search__icon" />
                </div>
                {/* 2024/11/11 Delete button */}
                {/* <Link
                    className="store-list-content__action__add"
            ...
            <div className="store-list-content__sub">
                <Table
                    className="store-list-content__sub__table"
                    columns={columns}
