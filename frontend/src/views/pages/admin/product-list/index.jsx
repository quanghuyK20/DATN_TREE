...
function ProductList() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <span
          className={record.deleted_at === "Đã bán" ? "span-red" : "span-green"}
        >
          {record.deleted_at}
        </span>
      ),
    ...
    return (
      <Menu className="product-list-menu">
        <div className="product-list-menu__item">
          ...
          <div className="product-list-menu__item__row">
            <span className="product-list-menu__item__row__span">Cửa hàng</span>
            <select
              className="product-list-menu__item__row__select"
              onChange={(e) => {
                e.target.value === "All"
          ...
          <div className="product-list-menu__item__row">
            <span className="product-list-menu__item__row__span">Dáng cây</span>
            <select
              className="product-list-menu__item__row__select"
              onChange={(e) => {
                e.target.value === "All"
