        ...
        if (id) {
            productApi.getProductById(id).then((response) => {
                const product = {
                    ...
                    price: Number(response.data[0][0].price),
                    store_id: response.data[0][0].store_id,
                    category_id: response.data[0][0].category_id,
                    desc: response.data[0][0].desc,
                    img: response.data[0][0].img ? response.data[0][0].img : defaultImageUrl.USER_AVATAR
                }
                setProduct(product);
            })
        }
            ...
            >
                ...
                <div className="edit-account-content__sub__info">
                    ...
                    <div className="edit-account-content__sub__info__item">
                        ...
                        >
                            <Select className="select" defaultValue={product.store_id}>
