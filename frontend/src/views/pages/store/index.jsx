                    ...
                    <div>
                        ...
                        <div className="container pb-4">
                            ...
                            <div className="shop-page-menu mt-5">
                                <div className="navbar-with-more-menu__items">
                                    <a className="navbar-with-more-menu__item navbar-with-more-menu__item--active" href="/phukienbincase">
                                        <span>Dạo</span>
                                    </a>
                                    <a className="navbar-with-more-menu__item" href="/phukienbincase#product_list">
                                        <span>Sản phẩm trả góp</span>
                                    </a>
                                    <a className="navbar-with-more-menu__item" href="/phukienbincase?shopCollection=244291969#product_list">
                                        <span>Tất cả sản phẩm</span>
                                    </a><a className="navbar-with-more-menu__item" href="/phukienbincase?shopCollection=158637119#product_list">
                                        <span>Sản phẩm bán chạy nhất</span>
                                    </a>
                                    <a className="navbar-with-more-menu__item" href="/phukienbincase?shopCollection=156922326#product_list">
                                        <span>Sản phẩm ưu đãi</span>
                                    </a>
                                    <a className="navbar-with-more-menu__item" href="/phukienbincase?shopCollection=156922380#product_list">
                                        <span>Thêm</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="store-product">
                            <div className="store-product__suggest container">
                                <div className='store-product__suggest__title'>MÃ GIẢM GIÁ CỦA SHOP</div>
                                ...
                                <div className='store-product__suggest__title'>GỢI Ý CHO BẠN</div>
